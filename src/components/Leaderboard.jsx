...
const WinnerCard = ({ position, label, teamImage, teamName }) => {
  return (
    <div
      className={`relative ${
        position === '1st' ? 'md:w-[320px] h-[350px]' : position === '2nd' ? 'md:w-[280px] h-[320px]' : 'md:w-[240px] h-[300px]'
  ...
  return (
    ...
    >
      ...
      <main className="relative z-10 mx-12">
        <div className="text-center text-yellow-400 tracking-widest font-bold pb-8 text-4xl sm:text-5xl md:text-6xl w-full mt-16 sm:mt-24">
          Leaderboard
        </div>
        <hr className="border border-yellow-400/40 mx-auto w-full" />

        <div className="flex flex-col gap-24 sm:gap-36 px-4 sm:px-6 md:px-12 py-12 sm:py-24">
