  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-between p-5 h-full">
        ...
        ></div>
        <div className="text-[#f0f0e0] font-serif bg-gradient-to-br from-[#826d21] via-[#c19b05] to-[#594809] w-full text-center py-2 rounded-xl font-bold sm:text-xl">
          {teamName}
        </div>
      </div>
    </div>
      ...
      <main className="relative z-10 mx-12">
        ...
        <div className="flex flex-col gap-24 sm:gap-36 px-4 sm:px-6 md:px-12 py-8 sm:py-24">
          {events.map((event, index) => {
            const teamDesktopOrder = [
              event.teams[2],
              event.teams[0],
              event.teams[1],
            ];
            const teamMobileOrder = [
              event.teams[0],
              event.teams[1],
              event.teams[2],
            ];
            ...
            return (
              <div key={index} className="flex flex-col gap-12">
                ...
                {/* Desktop View */}
                <section className="hidden md:flex flex-row-reverse items-center text-[800] justify-center gap-8 lg:gap-16 xl:gap-24">
